/**
 * Campos estándar compartidos por CRUDs (favoritos, etiquetas internas, notas).
 * Helpers para construir los CrudFormField canónicos y convertir el CSV ↔ array de etiquetas.
 */
import type { CrudFieldValue, CrudFormField } from "./types";
